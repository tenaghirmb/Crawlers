...
class KjrbpreviousSpider(Spider):
    ...
    start_urls = ['http://digitalpaper.stdaily.com/http_www.kjrb.com/kjrb/html/{year}-{month:02d}/{day:02d}/node_2.htm'.format(year=datetime.datetime.now().year, month=datetime.datetime.now().month, day=datetime.datetime.now().day)]
